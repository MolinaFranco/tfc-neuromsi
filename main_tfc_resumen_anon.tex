...
\author{Autor(es) anonimizado(s) para revisión a ciegas}

\institute{Afiliación anonimizada para revisión a ciegas}
...
Agradecimientos omitidos para revisión a ciegas. Serán incluidos en
