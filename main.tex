...
\makeatother
% 4. Asegurar que el entorno 'code' que creaste use el formato correcto
...
\input{./04_antecedentes/antecedentes.tex} \cleardoublepage 
\input{./05_modelos/modelos.tex} \cleardoublepage
\input{./06_neuromsi/neuromsi.tex} \cleardoublepage
\input{./07_implementacion/implementacion.tex} \cleardoublepage
\input{./08_resultados/resultados.tex} \cleardoublepage
\input{./09_conclu/conclu.tex} \cleardoublepage
\input{./10_apendice/apendice.tex} \cleardoublepage
